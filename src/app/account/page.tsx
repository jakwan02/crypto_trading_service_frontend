...
function formatJoinDate(value?: string | null, fallback?: string) {
...
export default function AccountPage() {
  ...
  const joinDate = useMemo(() => formatJoinDate(user?.created_at, t("account.joinDatePending")), [user, t]);
        ...
        <div className="mx-auto w-full max-w-6xl px-4 py-10">
          ...
          <section className="mb-6 grid gap-4 lg:grid-cols-3">
            ...
            <div className="rounded-3xl border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <p className="mt-3 text-sm text-gray-600">{t("account.securityDesc")}</p>
              <button
                type="button"
