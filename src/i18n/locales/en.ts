const en = {
  ...
  alerts: {
    ...
    outcomes: "Outcomes",
    replay: "Replay",
    err: "There was a delivery error.",
    webhooksTitle: "Webhooks",
    webhooksDesc: "Deliver alert events to your endpoint (HMAC signed, secret shown once).",
    webhookUrlPlaceholder: "https://example.com/webhook",
    webhookAdd: "Add",
    webhookRotate: "Rotate secret",
    webhookSecretTitle: "Webhook secret (shown once)",
    webhookSecretDesc: "This value is shown only on this screen. Store it safely.",
    webhookSecretClose: "Close"
  },
  push: {
    title: "Web push",
  ...
  account: {
    ...
    briefingDesc: "A quick summary based on your watchlist and alerts.",
    briefingNext: "No buy/sell advice. Data-only summary.",
    briefingCta: "Open briefing"
  },
  accountSettings: {
    title: "Settings",
    ...
    briefingDesc: "Configure in-app briefings and schedule.",
    briefingDaily: "Daily briefing",
    briefingDailyHour: "Hour",
    briefingWeekly: "Weekly briefing",
    briefingWeeklyDow: "Day",
    briefingWeeklyHour: "Hour",
    dow: {
      0: "Sun",
      1: "Mon",
      2: "Tue",
  ...
  adminDashboard: {
    ...
    desc: "View key numbers and quick actions.",
  ...
  adminUsers: {
    title: "Admin · Users",
    desc: "Search users and view status/role.",
    search: "Search",
  ...
  adminUserDetail: {
    ...
    desc: "Manage role/ent_grant/API keys.",
    profile: "Profile",
    role: "Role",
  ...
  adminBilling: {
    ...
    desc: "Handle refund requests and manage coupons.",
    refunds: "Refunds",
    coupons: "Coupons",
    refundRequests: "Refund requests",
    emptyRefunds: "No refund requests.",
    refundId: "refund_id",
    approve: "Approve",
    deny: "Deny",
  ...
  adminMonitoring: {
    ...
    desc: "View KPI by range (null when unavailable).",
    apiP95: "API p95",
    apiP99: "API p99",
    ...
    ingestLag: "Ingest lag (by market)",
  ...
  adminGrowth: {
    title: "Admin · Growth",
    desc: "Operate referrals/affiliate links.",
    referrals: "Referrals",
    affiliate: "Affiliate",
  ...
  adminCalendar: {
    ...
    desc: "Create/delete calendar events.",
    create: "Create event",
    type: "type",
    titleField: "Title",
    body: "Body (MD)",
  ...
  referral: {
    title: "Referral",
    desc: "Share your code and track rewards.",
    myCode: "My code",
    code: "Code",
    link: "Link",
    invited: "Invited",
    rewards: "Rewards",
    claimTitle: "Claim a code",
    claimDesc: "Available once after email verification.",
    claimPlaceholder: "Enter code",
    claimBtn: "Claim"
  },
  onboarding: {
    title: "Onboarding",
    ...
    symbolHint: "e.g. BTCUSDT,ETHUSDT",
    step2: "2) Create a watchlist",
    step2Desc: "Create a watchlist with selected symbols.",
    createWatchlist: "Create watchlist",
    done: "Done",
    step3: "3) Create an alert",
    step3Desc: "Create a default alert for one symbol.",
    ...
    steps: {
      ...
      anomaly_opened: "Explore anomalies",
      briefing_opened: "Read a briefing",
      methodology_opened: "Check methodology",
      strategy_created: "Create a strategy"
    }
  },
  search: {
    title: "Search",
  ...
  calendar: {
    title: "Calendar",
    desc: "Browse events and manage subscriptions.",
    filters: "Filters",
    type: "type",
    market: "market",
    symbol: "symbol",
    ...
    importance: "Importance",
    subscribe: "Subscribe",
    loginToSubscribe: "Login to manage your subscription.",
    channelEmail: "Email",
    enabled: "Enabled",
    disabled: "Disabled",
  ...
  developer: {
    title: "Developer",
    desc: "Create API keys and call /api/v1 (read-only).",
    createKey: "Create API key",
    name: "Name",
    namePlaceholder: "e.g. my-bot",
    create: "Create",
    oneTimeKeyTitle: "API key (shown once)",
    oneTimeKeyDesc: "This key is shown only on this screen. Store it safely.",
    close: "Close",
    keys: "My API keys",
    prefix: "Prefix",
    ...
    externalApiTitle: "External API (/api/v1)",
    externalApiDesc: "x-api-key auth, read-only. Same rate limit as your ent.",
    endpoints: "Endpoints",
    authHeader: "Auth header",
    rateLimitHint: "You may get 429 with Retry-After."
  },
  rankings: {
    title: "Rankings",
    desc: "Top symbols by turnover and 24h change.",
  ...
  breadth: {
    ...
    desc: "Summarize advance/decline and regime.",
    fieldMarket: "Market",
    fieldWindow: "Window",
    asOf: "As of",
    latestTitle: "Latest",
    ...
    top10Share: "Top10 share",
    historyTitle: "History (last 7 days)",
    historyDesc: "Public page provides up to 7 days.",
    colTime: "Time",
    colRegime: "Regime",
    colAdvRatio: "Adv ratio",
    colMedian: "Median",
    colTop10: "Top10"
  },
  anomalies: {
    title: "Anomaly Radar",
    desc: "Detect volume/volatility/liquidity anomalies.",
    fieldMarket: "Market",
    fieldWindow: "Window",
    fieldKind: "Kind",
    asOf: "As of",
    latestTitle: "Latest anomalies",
    hintReplay: "Use Replay to open the chart at the event time.",
    kind: {
      volume: "Volume",
  ...
  briefing: {
    title: "Briefing",
    desc: "Daily/weekly summary based on your watchlist and alerts.",
    kindLabel: "Kind",
    kind: {
      daily: "Daily",
      weekly: "Weekly"
    },
    settingsCta: "Briefing settings",
    asOf: "As of date",
    tz: "TZ",
    historyTitle: "History",
    historyDesc: "Recent briefings.",
    loadMore: "Load more"
  },
  strategy: {
    title: "Strategy Lab",
    desc: "Validate rules on historical data (no advice, no guarantees).",
    ...
    delete: "Delete",
    fieldName: "Name",
    namePlaceholder: "e.g. RSI mean-reversion",
    fieldMarket: "Market",
    marketLocked: "Market can't be changed after creation.",
    fieldTf: "Timeframe",
    fieldUniverse: "Universe (symbols)",
    symbolsPlaceholder: "e.g. BTCUSDT,ETHUSDT",
    universeHint: "Up to 200 · now {{n}}",
    symbols: "symbols",
    entryTitle: "Entry",
    exitTitle: "Exit",
    op: { and: "AND", or: "OR" },
    ...
    runDesc: "Runs asynchronously on the server.",
    run: "Run",
    runId: "run_id",
    status: "Status",
    running: "Running…",
  ...
  methodology: {
    title: "Methodology",
    desc: "Transparent docs for indicators/scores (definition, math, pitfalls).",
    loadMore: "Load more",
    empty: "No docs.",
    invalidSlug: "Invalid slug.",
    back: "Back to list"
  ...
  start: {
    title: "Start",
    desc: "Use playbooks to learn the core features fast.",
    progressTitle: "Progress",
    progressMeta: "{{done}}/{{total}} ({{pct}}%)",
    nextCta: "Next step",
    viewChecklist: "View checklist",
    loginTitle: "Login to save your progress",
    loginDesc: "Store onboarding checklist and next actions in your account.",
    signup: "Sign up",
    playbooksTitle: "Playbooks",
    playbooksDesc: "Follow guides to use core features in 10 minutes.",
    loadMore: "Load more",
    empty: "No docs."
  },
  adminStatus: {
