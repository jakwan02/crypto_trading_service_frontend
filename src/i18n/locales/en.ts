const en = {
  ...
  auth: {
    ...
    passwordPolicyHint: "Use 12+ characters with no spaces.",
    passwordConfirmLabel: "Confirm password",
    passwordConfirmPlaceholder: "Re-enter your password",
    otpLabel: "Verification code",
    otpPlaceholder: "Enter authentication code",
    otpCta: "Verify code",
    ...
    verifyAlready: "This email is already verified.",
    verifyExpired: "Verification token has expired.",
    verifyInvalid: "Verification token is invalid.",
    verifyCtaLogin: "Sign in",
    verifyCtaHome: "Go to home",
    verifyResendCooldown: "Resend available in {{seconds}}s",
    ...
    errorAccountLocked: "Your account is locked for security reasons.",
    lockedUntil: "Please try again after {{time}}.",
    lockedRemaining: "Time remaining: {{remain}}",
    lockedResetCta: "Unlock via password reset",
    lockedCtaHint: "You can unlock immediately with a password reset.",
    errorMfaRequired: "Two-factor authentication code is required.",
    errorInvalidMfa: "The authentication code is invalid.",
  ...
  security: {
    ...
    desc: "Manage two-factor authentication and account protection.",
    mfaHelpTitle: "2FA setup guide",
    mfaHelpStep1: "Install an authenticator app (Google Authenticator, Authy, etc.).",
    mfaHelpStep2: "Scan the QR code or enter the manual key to add your account.",
    mfaHelpStep3: "Enter the 6-digit code from the app to enable 2FA.",
    mfaHelpBackupWarning: "Backup codes are required for recovery. Store them safely.",
    copy: "Copy",
    copied: "Copied",
    mfaTitle: "Two-Factor Authentication (2FA)",
    mfaStatusOn: "2FA is currently enabled.",
    mfaStatusOff: "2FA is currently disabled.",
    mfaSetupCta: "Start 2FA setup",
    mfaManualKey: "Manual key",
    mfaCodeLabel: "Authentication code",
    mfaCodePlaceholder: "Enter authentication code",
    mfaConfirmCta: "Enable 2FA",
    mfaDisable: "Disable 2FA",
    mfaEnabled: "2FA has been enabled.",
    mfaDisabled: "2FA has been disabled.",
    backupTitle: "Backup codes",
    backupDownload: "Download",
    backupRegenerate: "Regenerate backup codes",
    backupRegenerated: "Backup codes regenerated.",
    backupOneTimeNotice: "Backup codes are shown only once. Store them safely.",
    passwordLabel: "Password",
    passwordPlaceholder: "Enter your password",
    passwordChangeTitle: "Change password",
    passwordChangeDesc: "Verify your current password before setting a new one.",
    ...
    passwordMissingDesc: "Your account currently has no password. You can use Google re-authentication for account deletion or 2FA disable, or set a password.",
    passwordMissingCta: "Set password",
    googleReauthTitle: "Google re-authentication",
    googleReauthDesc: "Google accounts use re-authentication to approve sensitive actions.",
    googleReauthCta: "Re-authenticate with Google",
    googleReauthDone: "Google re-authentication completed.",
    googleReauthDoneShort: "Google re-authenticated",
    googleReauthRequired: "Google re-authentication is required.",
    passwordSetTitle: "Set password",
    passwordSetDesc: "For Google sign-up accounts, you can set a local password once using Google re-authentication.",
    passwordSetGoogleHintTitle: "Google re-authentication",
    passwordSetGoogleHint: "Click the button below to re-authenticate with Google and issue a fresh ID token.",
    passwordSetGoogleCta: "Re-authenticate with Google",
    passwordSetGoogleDone: "Google re-authentication completed.",
    passwordSetGoogleDoneShort: "Google re-authenticated",
    passwordSetGoogleRequired: "Google re-authentication is required.",
    passwordSetMfaHint: "If 2FA is enabled, enter a TOTP code or a backup code.",
    passwordSetCta: "Set password",
    passwordSetDone: "Password has been set.",
    passwordSetBack: "Go back",
    passwordAlreadySet: "A password is already set for this account.",
    deleteTitle: "Delete account",
    deleteDesc: "You will be logged out immediately and your data will be deleted after the retention period.",
    deletePurge: "Your data will be permanently deleted after {{days}} days.",
  ...
  account: {
    ...
    security: "Security",
    securityDesc: "Manage 2FA and account protection.",
  ...
  accountSettings: {
    title: "Settings",
    desc: "Manage default trading options and notification/marketing consent.",
    loadFailed: "Failed to load settings.",
    empty: "Settings are not available yet.",
    sectionTrade: "Trading defaults",
    marketDefault: "Default market",
    sortDefault: "Default sort",
    tfDefault: "Default timeframe",
    ...
    alertSms: "SMS",
    alertPush: "Push",
    smsDisabled: "SMS will be available after phone verification is supported.",
    quietEnabled: "Quiet hours",
    quietStart: "Start",
    quietEnd: "End",
    ...
    sectionMarketing: "Marketing consent",
    marketingDesc: "You can withdraw anytime. Changes are stored as audit logs.",
    mktEmail: "Email",
    mktSms: "SMS",
    mktPush: "Push",
    marketingImmediate: "Marketing consent is saved immediately when toggled.",
    saved: "Saved.",
    synced: "Synced",
  ...
  payment: {
    ...
    bankAccountPlaceholder: "Enter bank and account number",
