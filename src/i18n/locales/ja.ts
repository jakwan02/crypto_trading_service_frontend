const ja = {
  ...
  auth: {
    loginTitle: "Googleでログイン",
    loginDesc: "ソーシャルログインで素早くアクセス。",
    loginCta: "Googleで続行",
    signupTitle: "新規登録",
    signupDesc: "CoinDashはGoogleログインのみ対応。ワンクリックで登録。",
    signupCta: "Googleでサインアップ",
    loginHelp: "ログインヘルプ",
    signupLink: "初めての方はこちら",
    loginLink: "ログイン",
    hasAccount: "アカウントをお持ちですか？",
    redirecting: "Googleログインに移動中...",
  ...
  account: {
    ...
    pro: "Pro",
    free: "無料",
    planMetaPro: "次回請求: 2025-12-31",
    planMetaFree: "Proにアップグレードして全指標を利用。",
    planCta: "Proにアップグレード",
    security: "セキュリティ",
    securityDesc: "2FA、ログイン通知、セッションを管理。",
    securityCta: "セキュリティ管理",
    payment: "支払い方法",
