const ja = {
  ...
  security: {
    ...
    mfaManualKey: "手動入力キー",
    mfaCodeLabel: "認証コード",
    mfaCodePlaceholder: "認証コードを入力してください",
  ...
  accountSettings: {
    title: "設定",
    desc: "デフォルト取引設定と通知/マーケ同意を管理します。",
    loadFailed: "設定の読み込みに失敗しました。",
    empty: "設定データを準備中です。",
    sectionTrade: "取引のデフォルト",
    marketDefault: "デフォルト市場",
    sortDefault: "デフォルト並び替え",
    tfDefault: "デフォルト時間足",
    sectionDisplay: "表示",
    currency: "通貨",
    language: "言語",
    ...
    alertSms: "SMS",
    alertPush: "プッシュ",
    smsDisabled: "SMSは電話番号認証に対応後に有効になります。",
    quietEnabled: "夜間停止",
    quietStart: "開始",
    quietEnd: "終了",
    ...
    sectionMarketing: "マーケ同意",
    marketingDesc: "いつでも撤回できます。変更は監査ログとして保存されます。",
    mktEmail: "メール",
    mktSms: "SMS",
    mktPush: "プッシュ",
    marketingImmediate: "マーケ同意はトグル直後に保存されます。",
    saved: "保存しました。",
    synced: "同期済み",
    unsaved: "未保存の変更",
    saving: "保存中…",
  ...
  upgrade: {
    ...
    cardExpiry: "有効期限",
    cardExpiryPlaceholder: "有効期限を入力してください",
    cvc: "CVC",
    cvcPlaceholder: "セキュリティコードを入力してください"
  },
  payment: {
    amountLabel: "チャージ金額",
    ...
    cardExpiryPlaceholder: "有効期限を入力してください",
    bankAccount: "入金口座",
    bankAccountPlaceholder: "銀行名と口座番号を入力してください",
