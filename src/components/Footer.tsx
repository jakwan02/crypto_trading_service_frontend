      ...
      <div className="mx-auto w-full max-w-6xl px-4 py-10 text-xs text-gray-500">
        <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
          <div className="space-y-2">
            <p className="text-sm font-semibold text-gray-900">CoinDash Labs</p>
          ...
          <div className="grid gap-2 text-xs">
            <span className="text-[11px] font-semibold uppercase tracking-wide text-gray-400">Policy</span>
