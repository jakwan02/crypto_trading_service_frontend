      ...
      <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between gap-3 px-4">
        ...
        <div className="flex items-center gap-3">
          <div className="hidden items-center gap-3 lg:flex">
            <div ref={searchWrapRef} className="relative">
              ...
              >
                <Search className="h-4 w-4" />
	              ...
	              {searchOpen ? (
	                <div className="fade-up absolute right-0 top-full z-[210] mt-2 w-80 rounded-2xl border border-gray-200 bg-white p-3 shadow-lg">
            ...
            {noticeOpen ? (
              <div className="absolute right-0 top-full z-[210] mt-2 w-72 rounded-2xl border border-gray-200 bg-white p-3 shadow-lg">
          ...
          {!sessionReady ? (
            ...
            <div ref={accountWrapRef} className="relative">
              ...
              {accountOpen ? (
                <div className="absolute right-0 top-full z-[210] mt-2 w-44 rounded-2xl border border-gray-200 bg-white p-2 shadow-lg">
                  <Link
                    href="/account"
